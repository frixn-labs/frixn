    ...
    <section id="tech" className="py-20 relative overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-6 max-w-[1100px] relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-0">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-[#007AFF]/5 border border-[#007AFF]/10 rounded-full px-3 py-1 mb-6">
              <Zap className="w-3.5 h-3.5 text-[#007AFF]" />
              <span className="text-[9px] font-black text-[#007AFF] uppercase tracking-[0.15em]">Sync Systems</span>
            </div>
            ...
            <motion.div
              whileHover={{ x: 5 }}
              className="flex items-center gap-2 text-[#007AFF] font-bold text-xs uppercase tracking-widest cursor-pointer"
            >
