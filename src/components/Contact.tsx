              ...
              {!isCompleted ? (
                ...
                >
                  <div className="space-y-4">
                    <div className="flex items-center gap-3 text-[#007AFF] font-black text-[10px] uppercase tracking-[0.3em]">
                    ...
                    <h3 className="text-2xl md:text-3xl font-bold text-foreground tracking-tight leading-tight flex items-start gap-4">
                       <currentQuestion.icon className="w-8 h-8 text-[#007AFF]/40 mt-1 shrink-0" />
                ...
                >
                  ...
                  <button 
                    ...
                    className="text-[#007AFF] font-bold text-xs uppercase tracking-widest hover:underline"
                  >
              ...
              {colors.map((c) => (
                <button
                  ...
                  className={`w-6 h-6 rounded-full border-2 transition-all hover:scale-110 relative ${
                    color.id === c.id ? 'border-[#007AFF] scale-110' : 'border-transparent'
                  }`}
                  style={{ backgroundColor: c.hex }}
                >
                   {color.id === c.id && (
                     <motion.div layoutId="color-ring-small" className="absolute -inset-1.5 border border-[#007AFF]/30 rounded-full" />
                   )}
                </button>
              ))}
            </div>
