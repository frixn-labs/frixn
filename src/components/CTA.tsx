    ...
    <section id="cta" className="py-24 relative overflow-hidden bg-background">
      <div className="container mx-auto px-6 relative z-10 max-w-[1200px]">
        ...
        >
          ...
          <div className="absolute inset-x-0 -top-40 h-80 bg-[#007AFF]/5 blur-[120px] pointer-events-none" />
          
          <div className="inline-flex items-center gap-2 bg-[#007AFF]/5 border border-[#007AFF]/10 rounded-full px-4 py-1.5 mb-8 relative z-10">
            <Sparkles className="w-3.5 h-3.5 text-[#007AFF]" />
            <span className="text-[10px] font-black text-[#007AFF] uppercase tracking-[0.2em]">The Future is Here</span>
          </div>
          ...
          <button className="relative z-10 px-10 py-5 bg-[#007AFF] hover:bg-[#007AFF]/90 text-white font-black rounded-full hover:scale-105 hover:shadow-2xl hover:shadow-[#007AFF]/20 transition-all flex items-center justify-center gap-3 mx-auto text-lg lowercase tracking-tight active:scale-95">
