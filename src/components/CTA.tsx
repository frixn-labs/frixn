    ...
    <section id="cta" className="py-24 relative overflow-hidden bg-background">
      <div className="container mx-auto px-6 relative z-10 max-w-[1200px]">
        ...
        >
          ...
          <div className="absolute inset-x-0 -top-40 h-80 bg-[#FF3D00]/5 blur-[120px] pointer-events-none" />
          
          <div className="inline-flex items-center gap-2 bg-[#FF3D00]/5 border border-[#FF3D00]/10 rounded-full px-4 py-1.5 mb-8 relative z-10">
            <Sparkles className="w-3.5 h-3.5 text-[#FF3D00]" />
            <span className="text-[10px] font-black text-[#FF3D00] uppercase tracking-[0.2em]">The Future is Here</span>
          </div>
          ...
          <button className="relative z-10 px-10 py-5 bg-[#FF3D00] hover:bg-[#FF3D00]/90 text-white font-black rounded-full hover:scale-105 hover:shadow-2xl hover:shadow-[#FF3D00]/20 transition-all flex items-center justify-center gap-3 mx-auto text-lg lowercase tracking-tight active:scale-95">
